...
public class CountBookActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Map<String, Object>> list=nodeDao.count_Book_getData(getApplicationContext());
        //列表项组
        String[] category={"bookname","count"};
        //列表项id
